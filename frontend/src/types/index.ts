...
export interface ReviewThemeTrendPoint {
  date: string;
  count: number;
  low_rating: number;
}

export interface ReviewThemeTrend {
  theme: string;
  total: number;
  low_rating: number;
  points: ReviewThemeTrendPoint[];
}

export interface ReviewTrendInsight {
  kind: "spike" | "drop";
  metric: string;
  date: string;
