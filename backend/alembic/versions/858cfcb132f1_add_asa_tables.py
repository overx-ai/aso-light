...
def upgrade() -> None:
    ...
    if not _has_table("asa_campaigns"):
        op.create_table(
            ...
            sa.Column("supply_sources", sa.JSON(), nullable=True),
            ...
            sa.Column("storefronts", sa.JSON(), nullable=True),
    ...
    if not _has_table("asa_metric_daily"):
        op.create_table(
            ...
            sa.Column("taps", sa.Integer(), server_default=sa.text("0"), nullable=False),
            sa.Column("installs", sa.Integer(), server_default=sa.text("0"), nullable=False),
            sa.Column("new_downloads", sa.Integer(), server_default=sa.text("0"), nullable=False),
            sa.Column("redownloads", sa.Integer(), server_default=sa.text("0"), nullable=False),
            sa.Column("spend_amount", sa.Numeric(18, 6), server_default=sa.text("0"), nullable=False),
